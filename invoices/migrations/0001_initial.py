    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Sent', 'Sent'), ('Paid', 'Paid'), ('Pending', 'Pending'), ('Cancelled', 'Cancel')], default='Draft', max_length=15)),
                ...
                ('accounts', models.ManyToManyField(related_name='accounts_invoices', to='accounts.account')),
                ...
                ('teams', models.ManyToManyField(related_name='invoices_teams', to='teams.teams')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.TextField(blank=True, null=True, verbose_name='Details')),
                ('due_date', models.DateField(blank=True, null=True)),
                ('assigned_to', models.ManyToManyField(related_name='invoice_history_assigned_to', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('from_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoice_history_from_address', to='common.address')),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_history', to='invoices.invoice')),
                ('to_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoice_history_to_address', to='common.address')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoice_history_created_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
