...
#     path(
#         "cancelled-mail/<int:invoice_id>/",
#         invoice_change_status_cancelled,
#         name="invoice_change_status_cancelled",
#     ),
#     path(
#         "paid-mail/<int:invoice_id>/",
#         invoice_change_status_paid,
#         name="invoice_change_status_paid",
#     ),
