    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ManyToManyField(related_name='opportunity_assigned_to', to='common.profile')),
                ('closed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='oppurtunity_closed_by', to='common.profile')),
                ('contacts', models.ManyToManyField(to='contacts.contact')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='opportunity_created_by', to='common.profile')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='oppurtunity_org', to='common.org')),
                ('tags', models.ManyToManyField(blank=True, to='accounts.tags')),
                ('teams', models.ManyToManyField(related_name='oppurtunity_teams', to='teams.teams')),
